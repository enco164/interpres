...
\textit{React} kuke (engl. \textit{hooks}) služe za korišćenje stanja u funkcijskim komponentama. U teoriji, kuke su funkcije 
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{kontroler}
