...
\textit{Kubernetes} apstrahuje hardversku infrastrukturu i pruža privid da je ceo centar ya podatke jedan veliki resurs. To omogućava
...
Čaura (eng. {\em Pod}) u \textit{Kubernetes}-u predstavnja najmanju jedinicu koja može da se konfiguriše i sa kojom može da 
...
%TODO ovoj recenici nije ovde mesto, vec pre opisivanja CI i CD. Isto i ya naredni pasus
