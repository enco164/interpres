...
mu da samostalno pripremi prezentaciju. // TODO: ref: PVeb.2014.04%20-%20arh.apl,veb.2.0.pdf
Ovakvom karakteristikom se smanjuje opterećenje servera, jer više ne mora da priprema prezentaciju.
Arhitektura teških klijenata podrazumeva intenzivno korišćenje \textit{JavaScript}-a.
...
Biblioteke su komponente koje su ulinkovane u program i pozivaju se pomoću funkcija koje se nalaze u 
...
rešava je pogodnije rešiti bazom podataka \textit{SQL}, dok je za neki drugi servis možda pogodnija graf baza.
