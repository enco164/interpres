\section{Arhitektura aplikacije}\label{ch:arhitektura}
...
\begin{itemize}
    ...
    Ne postoji nikakav problem dokle god postoji neki protokol komuniciraje. %TODO preformulisati prethodnu recenicu 
